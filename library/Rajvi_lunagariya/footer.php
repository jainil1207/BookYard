    ...
    <div class="container text-md-left">
        ...
        <div class="row text-md-left">
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                <h5 class="text-uppercase mb-4 fw-bold text-warning">MyCompany</h5>
                <p>
                    We provide high quality web solutions and modern digital services 
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                <h5 class="text-uppercase mb-4 fw-bold text-warning">Services</h5>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p><i class="bi bi-phone-fill me-2"></i> 91061 28068</p>
            </div>
